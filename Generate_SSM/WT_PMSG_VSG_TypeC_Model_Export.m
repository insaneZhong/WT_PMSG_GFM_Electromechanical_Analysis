...
%% WT-PMSG GFM-MWT MSC-DVC Type c Small-Signal Model
% Type c: grid-side active-power feedforward plus DC-link voltage PI
% correction generate the MSC q-axis current reference:
...
VSG.dvc_type = 'MSC-DVC Type c';
VSG.dvc_description = 'Delta i_m_q_ref = G_dvc(s)*Delta v_dc + K_ff*Delta p_m';
...
save(fullfile(export_dir, 'Unified_WT_PMSG_VSG_TypeC.mat'), 'Unified_GFMI');
