...
% 12) MSC outer DC-link voltage controller
% In this grid-forming WT structure, the grid-side converter performs VSG
% control and the machine-side converter regulates the DC-link voltage.
syms vdc_ref v_dc gamma_dc %Variables
syms k_pdc k_idc %Parameters
...
f_DVC = vdc_ref - v_dc;
h_DVC = [0;
         k_pdc*(vdc_ref - v_dc) + k_idc*gamma_dc];
...
save('Unified_WT_PMSG_VSG_Damping','Unified_GFMI');
