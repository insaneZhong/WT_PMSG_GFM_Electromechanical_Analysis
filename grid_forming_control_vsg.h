...
/* VSG frequency state aligned with the small-signal model:
 *   dw/dt = (P_ref - P_m - (w-w0)/mp)/(2*h*w0)
 * Small-signal source: EigenAnalysis/Parameters.m and
 * Generate_SSM/WT_PMSG_GFM_GWT_Model.m.
 * For the 1 MW / 50 Hz baseline:
 *   mp = 2*pi*(0.01*f_base)/(2*S_base) = 1.5707963e-6 (rad/s)/W
 *   h  = T_RoCoF/(2*mp*w0), with T_RoCoF=0.5, gives about 506.606.
 * Current nonlinear startup candidate uses H=250 after no-disturbance
 * screening; re-scan H if the mechanical or DC-link parameters change.
 */
#ifndef VSG_EQUIV_W0
#define   VSG_EQUIV_W0                         314.1592654f
#endif
#ifndef VSG_EQUIV_H
#define   VSG_EQUIV_H                          250.0f
#endif
#ifndef VSG_EQUIV_MP
#define   VSG_EQUIV_MP                         1.5707963e-6f
#endif
...
#endif
#ifndef CURRENT_ID_KC
#define   CURRENT_ID_KC                          0
#endif
#ifndef CURRENT_ID_KD
...
#endif
#ifndef CURRENT_IQ_KC
#define   CURRENT_IQ_KC                          0
#endif
#ifndef CURRENT_IQ_KD
...
#endif
#ifndef GSI_POWER_LPF_CUTOFF
#define   GSI_POWER_LPF_CUTOFF                20.0f
#endif
